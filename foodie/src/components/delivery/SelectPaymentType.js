...
export default function SelectPaymentType() {
  ...
  const placeOrder = () => {
    ...
    axios.put('/api/customer/cart/status' ,response ).then((res)=>{
      axios.post('/api/customer/order',{address,contact})
        ...
        <div className="grouped fields">
          <div className="field">
            <div className="ui disabled checkbox">
              <input type="radio" name="example2" readOnly onChange={selected} />
              <label>Card</label>
            </div>
          </div>
          <div className="field">
          ...
          <div className="field">
            <div className="ui radio checkbox">
              <input type="radio" name="example2" checked="checked" onChange={selected} />
